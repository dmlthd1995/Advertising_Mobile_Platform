...
#define BODY_RADIUS  160 //mm
#define REDUCTION_RATIO_NAMIKI_MOTOR 80
#define WHEEL_RADIUS  23
...
void loop() {
  ...
  //drive_line_body_frame(0, 0, 1);
  drive_line_body_frame(3, -3, 2); // Front
  drive_line_body_frame(-3, 3, 2);  // Back
  //drive_line_body_frame(0, 0.10, 2);
  //drive_line_body_frame(0, -0.10, 2);
